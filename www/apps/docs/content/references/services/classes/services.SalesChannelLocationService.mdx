...
<ParameterTypes parameters={[{"name":"SalesChannelLocationService","type":"`object`","description":"Service for managing the stock locations of sales channels","optional":false,"defaultValue":"","expandable":false,"children":[]}]} />
