...
<ParameterTypes parameters={[{"name":"AuthService","type":"`object`","description":"Can authenticate a user based on email password combination","optional":false,"defaultValue":"","expandable":false,"children":[]}]} />
